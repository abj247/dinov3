...
from .datasets import ADE20K, CocoCaptions, ImageNet, ImageNet22k, NYU, HuggingFaceDataset
...
def _parse_dataset_str(dataset_str: str):
    ...
    for token in tokens[1:]:
        ...
        assert key in ("root", "extra", "split", "path")
        kwargs[key] = value
    ...
    if name == "ImageNet":
        ...
        # Pass all kwargs to the dataset class
    else:
